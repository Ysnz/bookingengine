...
def onBooked(instance, **kwargs):
    ...
    if (
        ...
        and (instance.check_in and instance.check_out) is not None
    ):
        ...
        instance.isBooked == False
        and (instance.check_in and instance.check_out) is None
    ):
        reservation_instance = Reservation.objects.filter(hotel_room_id=instance.id)
